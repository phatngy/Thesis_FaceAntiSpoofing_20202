...
def _TripletSemiHardLoss(y_true, y_pred, device, margin=1.0):
    ...
    adjacency_not = adjacency.byte() ^ 1
...
class TripletLoss(nn.Module):
    ...
    def forward(self, target, input, **kwargs):
        return _TripletSemiHardLoss(target, input, self.device)
