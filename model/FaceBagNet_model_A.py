...
class Net(nn.Module):
    ...
    def __init__(self, num_class=2, id_class = 300, is_first_bn = False):
        ...
        encode_tmp = FaceBagNet_model_A(num_classes=1000)
        self.conv1 = encode_tmp.layer0
        self.conv2 = encode_tmp.layer1
        self.conv3 = encode_tmp.layer2
        # self.conv4 = encode_tmp.layer3
        # self.conv5 = encode_tmp.layer4

        self.fc = nn.Sequential(nn.Linear(1024, num_class))
        self.id_fc = nn.Sequential(nn.Linear(1024, id_class))
